...
import { InvoiceId, QuotePayload } from '@/types/types-stripe';
...
export async function triggerNotificationSendToAdmin(orgId: string, workflow: string, payload?: InvoicePayload | InvoiceId | QuotePayload) {
