...
export default function Footer() {
    return (
        <footer className=" bg-green-900 text-white py-8 px-4 mb-0">
                ...
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 ">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link href="/lists/client" className="hover:text-green-300">Client List</Link>
                            </li>
                            <li>
                                <Link href="/billing/manage/invoices" className="hover:text-green-300">Billing</Link>
                            </li>
                            <li>
                                <Link href="/documentation" className="hover:text-green-300">Documentation</Link>
                            </li>
                        </ul>
                    </div>
                    <div className=" flex flex-col items-center">
