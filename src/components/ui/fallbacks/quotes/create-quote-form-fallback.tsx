        ...
        <>
            <form className="space-y-4">
                ...
                <section>
                    ...
                    <input id="labourCostPerUnit" type="number" className={inputClassName} min="0" step="0.01" defaultValue={0} />
                    <label htmlFor="labourUnits" className="block text-sm font-medium text-gray-700">Labour Units</label>
                    <input id="labourUnits" type="number" className={inputClassName} min="1" step="1" defaultValue={0} />
                </section>
                ...
                <section>
                    ...
                    <div className="border p-4 mb-4 rounded-md">
                        <label htmlFor="materialType" className="block text-sm font-medium text-gray-700">Material</label>
                        <input
                            id={`materialType`}
                            type="text"
