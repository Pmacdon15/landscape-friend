...
export default function SetViewMapButton({ children, setFunction, functionText }: { children: React.ReactNode, setFunction: React.Dispatch<React.SetStateAction<string>>, functionText: string }) {
